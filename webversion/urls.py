...
urlpatterns = [
    ...
    path("<str:email>/<int:college_id>/timetable/<int:timetable_id>",views.timetable, name="timetablePage"),
    ...
    path("<str:email>/deletetimetable/<int:college_id>/<int:timetable_id>", views.deleteTimetable, name="deleteTimetable"),
    path("<str:email>/allcolleges", views.collegePage, name="colleges"),
